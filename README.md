...
1.1  **Sign Up**: Go to [Supabase.com](https://supabase.com/) and create a free account.
1.2  **Create Project**: Start a new project (e.g., `Trial-Portal`).
1.3  **Create Table**: Navigate to the **SQL Editor** in your Supabase dashboard and run:
    ```sql
